...
class MultiDocumentStore:
    ...
    def _get_document_path(self, doc_id: str) -> str:
        ...
        return os.path.join(self.base_path, self.get_safe_doc_id(doc_id))

    def get_safe_doc_id(self, doc_id: str) -> str:
        """Return the sanitized document ID used on disk and in API responses."""
